...
def get_flat_identity_comparison(
    ...
    4. **Cross-type** — one side uses a positional descriptor
    ...
    5. **ELSE** — same naming system but values differ (e.g.
       FLAT A vs FLAT B); very heavy penalty.
    """
    ...
    flat_identity_comparison = {
        ...
        "comparison_levels": [
            ...
            # Same naming system but values differ → wrong flat
            {
                "sql_condition": "ELSE",
