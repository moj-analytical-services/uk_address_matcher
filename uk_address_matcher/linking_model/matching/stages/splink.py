...
class SplinkStage(MatchingStage):
    ...
    This stage runs:
    1. get_linker() — creates the Splink Linker
    ...
    4. best_matches_with_distinguishability() — computes distinguishability
    5. Threshold + rank filtering to select top-1 match per messy record
    ...
    additional_columns_to_retain: Optional[list[str]] = None

    # Advanced: supply custom Splink settings
    settings: Optional[SettingsCreator] = None
